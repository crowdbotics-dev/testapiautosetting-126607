...
## Project Structure
    ...
    ├── testapiautosetting_126607  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126607`
...
2. Clone this repo and `cd testapiautosetting_126607`
